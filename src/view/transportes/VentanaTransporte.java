...
public class VentanaTransporte extends javax.swing.JFrame {
    ...
    public void actualizarTabla() {
        tablaTransportesAdministrador.setModel(Tabla.modeloTabla(transports.getTransportes(), header));
    }
    ...
    private void initComponents() {
        ...
        tablaTransportesAdministrador = new javax.swing.JTable();
        ...
        tablaTransportesAdministrador.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tablaTransportesAdministrador.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaTransportesAdministradorMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablaTransportesAdministrador);
    ...
    private void lblAgregarTransporteMouseClicked(java.awt.event.MouseEvent evt) {
        // TODO add your handling code here:
        VentanaAgregarTransporte vat = new VentanaAgregarTransporte();
        vat.setVisible(true);
        this.dispose();
    }
    ...
    private void lblEditarTransporteMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if(selection>=0){
            VentanaEditarTransporte vet = new VentanaEditarTransporte(Integer.parseInt(tablaTransportesAdministrador.getValueAt(selection, 0).toString()));
            vet.setVisible(true);
            this.dispose();
        }
    }
    ...
    private void tablaTransportesAdministradorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaTransportesAdministradorMouseClicked
        // TODO add your handling code here:
        int selection = tablaTransportesAdministrador.getSelectedRow();
        if(selection>=0){
            lblNombreTransporte.setText(tablaTransportesAdministrador.getModel().getValueAt(selection, 1).toString());
            lblTelefonoTransporte.setText(tablaTransportesAdministrador.getModel().getValueAt(selection, 2).toString());
            lblDireccionTransporte.setText(tablaTransportesAdministrador.getModel().getValueAt(selection, 3).toString());
            lblIDTransporte.setText(tablaTransportesAdministrador.getModel().getValueAt(selection, 0).toString());
        }
    }//GEN-LAST:event_tablaTransportesAdministradorMouseClicked
    ...
    private javax.swing.JTable tablaTransportesAdministrador;
