 ...
 * @version 0.1
 */
public class VentanaAgregarTransporte extends javax.swing.JFrame {
        ...
        if (!txtNombre.getText().equals("")) {
            ...
            if (!txtDireccion.getText().equals("")) {
                ...
                if (!txtTelefono.getText().equals("")) {
                    Transporte t = new Transporte(txtNombre.getText(),txtTelefono.getText(),txtDireccion.getText());
                    if (transports.crearTransporte(t)) {
                        JOptionPane.showMessageDialog(this, "se ha ingresado el transporte!");
                        VentanaTransporte vua = new VentanaTransporte(t);
                        vua.setVisible(true);
                        this.dispose();
                    } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAgregarTransporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAgregarTransporte().setVisible(true);
            }
        });
    }
