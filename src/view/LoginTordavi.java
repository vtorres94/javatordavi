...
public class LoginTordavi extends javax.swing.JFrame {
    ...
    public LoginTordavi() {
        ...
        HiloConexion hiloConexion = new HiloConexion(lblConexion);
        hiloConexion.start();
    ...
    public void validarLogin() {
        if (!txtUsuario.getText().equals("") || txtPassword.getPassword().length != 0) {
            String password = "";
    ...
    private void initComponents() {
        ...
        lblConexion.setForeground(new java.awt.Color(51, 255, 51));
    ...
    class HiloConexion extends Thread{
        javax.swing.JLabel lblStatusConection;
        HiloConexion(javax.swing.JLabel lblStatusConection){
            this.lblStatusConection=lblStatusConection;
            lblStatusConection.setText("Conectado");
            lblStatusConection.setForeground(Color.green);
        }
        @Override
        public void run() {
            while(true){
                if(!ConexionDB.isConnected()){
                    lblStatusConection.setText("Sin Conexión");
                    lblStatusConection.setForeground(Color.red);
                }else{
                    lblStatusConection.setText("Conectado");
                    lblStatusConection.setForeground(Color.green);
                }
