...
public class VentanaEditarUsuario extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VentanaEditarUsuario
     */
    public VentanaEditarUsuario(int idUsuario) {
        initComponents();
        ...
        user = users.getUsuarioByID(idUsuario);
        llenarDatos();
    }
    ...
    private void initComponents() {
        ...
        try{
            ...
            lblIDUsuario.setText("EDITAR USUARIOS");
        ...
        lblEditarUsuario.setPreferredSize(new java.awt.Dimension(44, 44));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lblEditarUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    public void llenarDatos() {
        ...
        txtSegundoNombre.setText(user.getSegundoNombre());
        txtApellidoPaterno.setText(user.getApellido());
        txtApellidoMaterno.setText(user.getSegundoApellido());
        comboPuestos.setSelectedItem(user.getPuesto().toUpperCase());
        txtSalario.setText(user.getSalario().toString());
                            ...
                            if (!txtPassword.getText().equals("")) {
                                ...
                                if (!users.validarUsuario(txtUsuario.getText())) {
                                    ...
                                    if (users.editarUsuario(u)) {
                                        ...
                                        JOptionPane.showMessageDialog(this, "NO se ha modificado el usuario!");
                                    }
                                } else {
