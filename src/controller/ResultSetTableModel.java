...
public class ResultSetTableModel extends AbstractTableModel {
   ...
   public ResultSetTableModel(String consulta ) throws SQLException, ClassNotFoundException
   {
      // cargar clase de controlador de base de datos
      Class.forName( ConexionDB.controlador );

      // conectarse a la base de datos
      

      // crear objeto Statement para consultar la base de datos
      instruccion = ConexionDB.cnx.createStatement(
